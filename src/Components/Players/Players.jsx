...
const [selectedPlayers,setSelectedPlayers]=useState([]);
    return (
        <div className='container mx-auto mt-5 '>
            <div className='flex justify-between items-center mb-5 border-b border-red-700 pb-2 '>
                <h1 className='font-bold text-2xl italic'>{selected === 'available'?"Available Players": `Selected Players(${selectedPlayers.length}/${players.length})`}</h1>
                <div className='' >
